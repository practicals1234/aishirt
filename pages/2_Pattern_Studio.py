...
# --- 1. APP CONFIGURATION ---
st.set_page_config(
    page_title="Pattern AI Studio | Professional Shirting", 
    page_icon="👔", 
    layout="centered"
)
...
# Track usage for the ₹1000 budget
if "total_spent_inr" not in st.session_state:
    st.session_state.total_spent_inr = 0
...
STYLE_MAP = {
    "Curated Outfit Grid": "A top-down 'flat lay' of a curated menswear outfit. The centerpiece is a folded shirt made of the uploaded fabric. Surround it with prfessioal accessories like a leather watch, sunglasses, a tie, and a pocket square. Use soft natural lighting to highlight the fabric texture and colors.",
